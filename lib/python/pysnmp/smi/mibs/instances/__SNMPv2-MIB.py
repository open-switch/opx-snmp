...
__sysDescr = CustomMibScalarInstance(sysDescr.name, (0,), DisplayString())

__sysObjectID = CustomMibScalarInstance(sysObjectID.name, (0,), ObjectIdentifier())
...
__sysContact = CustomMibScalarInstance(sysContact.name, (0,), DisplayString())
__sysName = CustomMibScalarInstance(sysName.name, (0,), DisplayString())
__sysLocation = CustomMibScalarInstance(sysLocation.name, (0,), DisplayString())
__sysServices = CustomMibScalarInstance(sysServices.name, (0,), Integer32())
